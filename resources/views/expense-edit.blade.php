                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm">
                                                    <input type="text" name="expense_name" value="{{$i->expense_name}}" class="form-control" placeholder="Enter Name/ID" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="date" name="expense_date" value="{{$i->expense_date}}" placeholder="dd/mm/yy" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <select class="form-control " name="expense_perpous" required>
                                                        <option value="{{$i->expense_perpous}}" >{{$i->expense_perpous}}</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <select class="form-control " name="department" required>
                                                        <option value="{{$i->deparment}}" >{{$i->department_name}}</option>
                                                        @foreach ($department as $j)
                                                        <option value="{{$j->id}}" >{{$j->department_name}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="expense_details" value="{{$i->expense_details}}" id="" cols="40" rows="10" required>{{$i->expense_details}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" name="expense_cost" value="{{$i->expense_cost}}"  placeholder="Expense Cost" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
