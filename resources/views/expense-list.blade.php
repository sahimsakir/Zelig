                                    ...
                                    <form class="row row-cols-lg-auto g-3 align-items-center">
                                        <div class="col-12">
                                            ...
                                            <div class="input-group">
                                                <input type="text" id="myInput" class="form-control" id="inlineFormInputGroupUsername" placeholder="Username">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody id="myTable">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/edit-expense/{{$i->id}}" class="btn btn-primary btn-sm">See Details</a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
