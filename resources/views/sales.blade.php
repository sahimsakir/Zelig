                            ...
                            <div class="card-body">
                                ...
                                <form class="form-sample" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm">
                                                    <input type="text" name="product_name" class="form-control" placeholder="Enter Name/ID" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" name="reference" placeholder="Reference / Sales Number" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="number" name="purchase_cost" placeholder="Enter Purchase Cost" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="date" name="sale_date" placeholder="Enter sale date" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="text" name="purchase_from" placeholder="Enter purchase from" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="text" name="quantity" placeholder="Enter perpous" class="form-control" required />
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="number" name="sale_ammount" placeholder="Enter sales Ammount" class="form-control" required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="number" name="due_ammount" placeholder="Enter Due Ammount" class="form-control" required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="number" name="profit_ammount" placeholder="Enter perpous" class="form-control" required />
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="col-sm-12">Profit In percentage(%)</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" name="profit_percentage" placeholder="Enter perpous" class="form-control" required />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="date" name="due_date" placeholder="Enter perpous" class="form-control" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div>
                                                <label for="formFileLg" class="form-label">Attach Document</label>
