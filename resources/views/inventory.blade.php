                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-sample" action="{{route('add_inventory')}}" method="post">
                                    @csrf
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="date" placeholder="dd/mm/yy" name="date" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                <input type="number" placeholder="Enter Purchase Cost" name="cost" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                   <input type="text" placeholder="Enter perpous" name="perpous" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-12">
                                                   <input type="text" placeholder="Enter perpous" name="quantity" class="form-control"  required />
                                                </div>
                                                </div>
                                                <div class="col-sm-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <textarea name="detail" id="" cols="40" rows="10"  required></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="col-sm-12">
                                                   <input type="number" placeholder="Enter perpous" name="balance" class="form-control" required />
                                                </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="col-sm-12">Used</label>
                                                    <div class="col-sm-12">
                                                    <input type="number" placeholder="Enter perpous" name="used" class="form-control" required />
                                                </div>
                                                </div>
                                            </div>
                                        </div>
