                               ...
                               <h3>Add a payment</h3>
                                <form class="form-sample" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-sm-12 "> Enter ammount</label>
                                                <div class="col-sm">
                                                    <input type="number" value="{{$i->ammount}}" name="ammount" class="form-control"  placeholder="Enter ammount"  required />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="date" name="date" value="{{$i->date}}" placeholder="dd/mm/yy" class="form-control" required />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                <label class="col-sm-12 "> Enter Department</label>
                                                <div class="col-sm">
