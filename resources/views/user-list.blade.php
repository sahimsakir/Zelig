                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if ($j->id == $i->department)
                                                    {{$j->department_name}}
                                                    @endif
                                                    @endforeach
                                                </td>
                                                <td>
                                                     <a href="/user-edit/{{$i->id}}"class="btn btn-primary btn-sm">See Details</a>
                                                     <form action="/user-delete/{{$i->id}}" method="post" onsubmit="return confirm('Are you sure?');">
                                                        @csrf
